...
function localRefinementOptions(options) {
	...
	return {
		...
		localRefinementDirectPoses: booleanOption(optionValue(options, 'localRefinementDirectPoses', 'local-refinement-direct-poses', undefined), false),
		directPoseMaxTargets: Math.floor(numberOption(optionValue(options, 'directPoseMaxTargets', 'direct-pose-max-targets', undefined), 6, 1, 64)),
		directPoseMaxCandidates: Math.floor(numberOption(optionValue(options, 'directPoseMaxCandidates', 'direct-pose-max-candidates', undefined), 24, 1, 256)),
...
function buildConfigPreset(rotations, fitnessVersion, refinementOptions, mergeConfig, adaptiveConfig, superpartConfig) {
	...
	return {
		...
		localRefinementDirectPoses: refinementOptions.localRefinementDirectPoses,
		directPoseMaxTargets: refinementOptions.directPoseMaxTargets,
		directPoseMaxCandidates: refinementOptions.directPoseMaxCandidates,
